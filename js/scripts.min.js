...
$(function() {
	$("#nav-menu").mmenu({
		...
		"navbar": {
			title: '<object type="image/svg+xml" data="../img/logo.svg" id=’object’ alt="" class=’logo’></object>'
		},
		"navbars": [{
			"position": "bottom",
			"content": [
				"<a href='#'><i class='icon-fb'></i></a>",
				"<a href='#'><i class='icon-im'></i></a>",
				"<a href='#'><i class='icon-tg'></i></a>"
			]
		}]
	});
	
	var nav_api = $('#nav-menu').data('mmenu');

	nav_api.bind('open:start', function () {
		$('.hamburger').addClass('is-active');
	});
	nav_api.bind('close:before', function () {
